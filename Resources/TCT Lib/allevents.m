% name2 = allevents(name1)
function allevents(name2, name1)
global path;
global tct_name;
global prm_file; 
global rst_file;
...
%--------------------------------------------------------------------------
% generate the prm file for Allevents
...
fprintf(fid, '%s = Allevents(%s)', name2, name1);
