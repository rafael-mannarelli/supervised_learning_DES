% name2 = relabel(name1, state pair)
function relabel(name2, name1, state_pair)
global path;
global tct_name;
global prm_file; 
global rst_file;
...
%--------------------------------------------------------------------------
% generate the prm file for relabel
...
fprintf(fid, '%s = Relabel(%s,[', name2, name1);
[m,n] = size(state_pair);
for i = 1:m
