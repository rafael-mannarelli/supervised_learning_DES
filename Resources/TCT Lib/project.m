% name2 = project(name1, null_list)
function project(name2, name1, null_list)
global path;
global tct_name;
global prm_file; 
global rst_file;
...
%--------------------------------------------------------------------------
% generate the prm file for project
...
fprintf(fid, '%s = Project(%s,Null[', name2, name1);
for i = 1:length(null_list)
