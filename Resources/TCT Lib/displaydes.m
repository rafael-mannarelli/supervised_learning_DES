% name1 = displaydes(name2)
function displaydes(varargin)
global path;
global prm_file; 
global rst_file;
global tct_name;
...
%--------------------------------------------------------------------------
% generate the prm file for dispdes
...
fprintf(fid, '0\n'); % debug_mode
fprintf(fid, '1\n'); % min_flag
fprintf(fid, '%d\n', code); % code for dispdes
fprintf(fid, '%s\n', name1); % name of target figure
fprintf(fid, '%s\n', name2); % name of DES to be converted
