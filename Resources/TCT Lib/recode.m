...
%--------------------------------------------------------------------------
% generate the prm file for BFS_Recode
...
fprintf(fid, '%s = Recode(%s)', name2, name1);
